...
export class AccountService {
  ...
  getCodeConfirm(email: string): Observable<any> {
    return this.http.get(this.baseURL + 'api/confirm/guest/' + email);
  }

  //DungNV
  public findAccount(accountId: number): Observable<any> {
    return this.http.get(this.baseURL + 'api/account/find/' + accountId, this.httpOptions);
  }

//DungNV
  public updateEmail(oldEmail: string, newEmail: string): Observable<any> {
    return this.http.get(this.baseURL + 'api/account/update-email/' + oldEmail + '/' + newEmail, this.httpOptions);
  }
}
